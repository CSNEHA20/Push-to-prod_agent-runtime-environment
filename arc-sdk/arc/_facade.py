...
:class:`NotImplementedError` until the runtime engines are wired in.
"""
...
class ARC:
    ...
    def trace(self, session_id: Optional[str] = None) -> List[TraceStep]:
    ...
    def recover(self, session_id: Optional[str] = None) -> RecoveryPlan:
    ...
    def verify(
        self,
        session_or_trace: Union[str, List[TraceStep], List[Dict[str, Any]], None] = None,
    ...
    def replay(self, session_id: Optional[str] = None) -> ReplayTimeline:
    ...
    def inspect(self, session_id: Optional[str] = None) -> Session:
    ...
    def middleware(self, mw: Optional[Middleware] = None) -> Middleware:
        ...
        def _register(candidate: Middleware) -> Middleware:
    ...
    def plugin(
        self, plugin: Optional[Union[Plugin, Type[Plugin]]] = None
    ) -> Union[Plugin, Type[Plugin]]:
        ...
        def _register(
            candidate: Union[Plugin, Type[Plugin]]
        ) -> Union[Plugin, Type[Plugin]]:
